    ...
    abilities = (
        (
            ...
            Skill(
                name="Vulnerability Down",
                offensive_debuff_spec=OffensiveStatusEffectSpec(
                    duration=10*1000, damage_mult=1-0.75, is_party_effect=True
                ),
                timing_spec=base_timing_spec,
                is_GCD=False,
            ),
        ...
        (
            ...
            Skill(
                name="Damage Down",
                offensive_buff_spec=OffensiveStatusEffectSpec(
                    duration=30 * 1000, damage_mult=1-0.3, is_party_effect=False
                ),
                timing_spec=base_timing_spec,
                is_GCD=False,
            ),
...
def create_external_skill_library(encounter_id):
    encounterid_to_external = {
        ...
        #
        101: get_dd_ability(30 * 1000, 0.25),  # m9s
        102: create_m10s_map(),
        103: get_dd_ability(30 * 1000, 0.35),  # m11s
        104: get_dd_ability(30 * 1000, 0.5),  # m12s p1
        105: get_dd_ability(30 * 1000, 0.5),  # m12s p2
