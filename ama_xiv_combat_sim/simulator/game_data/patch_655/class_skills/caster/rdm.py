...
def add_rdm_skills(skill_library):
    ...
    verfire_damage_follow_up = FollowUp(
        skill=Skill(name="Verfire", damage_spec=DamageSpec(potency=340)),
        delay_after_parent_application=800,
    )
    skill_library.add_skill(
        Skill(
    ...
    verstone_damage_follow_up = FollowUp(
        skill=Skill(name="Verstone", damage_spec=DamageSpec(potency=340)),
        delay_after_parent_application=800,
    )
    skill_library.add_skill(
        Skill(
    ...
    jolt_2_damage_follow_up = FollowUp(
        skill=Skill(name="Jolt II", damage_spec=DamageSpec(potency=320)),
    ...
    verthunder_3_damage_follow_up = FollowUp(
        skill=Skill(name="Verthunder III", damage_spec=DamageSpec(potency=380)),
        delay_after_parent_application=760,
    )
    skill_library.add_skill(
        Skill(
    ...
    veraero_3_damage_follow_up = FollowUp(
        skill=Skill(name="Veraero III", damage_spec=DamageSpec(potency=380)),
        delay_after_parent_application=760,
    )
    skill_library.add_skill(
        Skill(
