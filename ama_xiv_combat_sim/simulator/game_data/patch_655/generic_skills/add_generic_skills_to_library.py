from ama_xiv_combat_sim.simulator.game_data.patch_655.lb_skills.add_lbs_to_skill_library import (
...
def __get_pot(name, main_stat_add):
    res = Skill(
        ...
        timing_spec=TimingSpec(
            base_cast_time=0, animation_lock=1300, application_delay=890
        ),
