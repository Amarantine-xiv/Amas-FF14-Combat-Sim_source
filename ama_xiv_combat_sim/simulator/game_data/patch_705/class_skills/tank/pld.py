    ...
    skill_library.add_skill(
        Skill(
            ...
            damage_spec={
                ...
                "Divine Might": DamageSpec(potency=500),
                "Requiescat": DamageSpec(potency=700),
                "Divine Might, Requiescat": DamageSpec(potency=500),
            },
            timing_spec={
    ...
    skill_library.add_skill(
        Skill(
            ...
            damage_spec={
                ...
                "Requiescat": DamageSpec(potency=1000),
            },
            timing_spec=TimingSpec(
                base_cast_time=0, animation_lock=650, application_delay=623
            ),
    ...
    skill_library.add_skill(
        Skill(
            ...
            damage_spec={
                ...
                "Requiescat": DamageSpec(potency=760),
            },
            timing_spec=TimingSpec(
    ...
    skill_library.add_skill(
        Skill(
            ...
            damage_spec={
                ...
                "Requiescat": DamageSpec(potency=880),
            },
            timing_spec=TimingSpec(
