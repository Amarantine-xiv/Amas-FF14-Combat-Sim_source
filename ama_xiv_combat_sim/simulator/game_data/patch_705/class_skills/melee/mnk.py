...
def add_mnk_skills(skill_library):
    ...
    # bootshine does not exist at lvl 100
    skill_library.add_skill(
        Skill(
            name="Bootshine",
            is_GCD=True,
            damage_spec={
                ...
                "Opo-opo's Fury": DamageSpec(potency=420),
                "Opo-opo's Fury, Opo-opo Form": DamageSpec(
                    potency=420, guaranteed_crit=ForcedCritOrDH.FORCE_YES
                ),
                "Opo-opo's Fury, Formless Fist": DamageSpec(
                    potency=420, guaranteed_crit=ForcedCritOrDH.FORCE_YES
                ),
                "Opo-opo's Fury, Formless Fist, Opo-opo Form": DamageSpec(
                    potency=420, guaranteed_crit=ForcedCritOrDH.FORCE_YES
                ),
            },
            timing_spec=TimingSpec(
    ...
    # snap punch does not exist at lvl 100
    skill_library.add_skill(
        Skill(
            name="Snap Punch",
            is_GCD=True,
            damage_spec={
                ...
                "No Positional": DamageSpec(potency=270),
                "Coeurl's Fury": DamageSpec(potency=480),
    ...
    skill_library.add_skill(
        Skill(
            ...
            damage_spec={
                ...
                "Opo-opo Form": DamageSpec(
                    potency=120, guaranteed_crit=ForcedCritOrDH.FORCE_YES
                ),
                "Formless Fist": DamageSpec(
                    potency=120, guaranteed_crit=ForcedCritOrDH.FORCE_YES
                ),
    ...
    skill_library.add_skill(
        Skill(
            name="Phantom Rush",
            is_GCD=True,
            damage_spec=DamageSpec(potency=1500),
            timing_spec=TimingSpec(
                base_cast_time=0,
                animation_lock=650,
                application_delay=400,
