...
def add_blm_skills(skill_library):
    ...
    def get_enochian_damage_spec_cross(base_potency, is_fire_spell):
        ...
        for elem_str in elem_strs:
            ...
            res[elem_str] = DamageSpec(
                potency=int(base_potency), single_damage_mult=potency_modifier
            )
        return res
    ...
    enochian_buff = Skill(
        name="Enochian",
        is_GCD=False,
        buff_spec=StatusEffectSpec(damage_mult=1.33, duration=15 * 1000),
    )
    ...
    high_thunder_dot = Skill(
        name="Thunder (dot)",
        is_GCD=False,
        damage_spec=DamageSpec(potency=60, damage_class=DamageClass.MAGICAL_DOT),
    )
    ...
    skill_library.add_skill(
        Skill(
            ...
            is_GCD=True,
            damage_spec=get_enochian_damage_spec_cross(
                base_potency=320, is_fire_spell=False
            ),
            timing_spec=get_enochian_timing_spec_cross(
    ...
    skill_library.add_skill(
        Skill(
            ...
            is_GCD=True,
            damage_spec=get_enochian_damage_spec_cross(
                base_potency=320, is_fire_spell=True
            ),
            timing_spec=get_enochian_timing_spec_cross(
