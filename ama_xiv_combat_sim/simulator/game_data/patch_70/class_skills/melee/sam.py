...
def add_sam_skills(skill_library):
    ...
    jinpu_follow_up = FollowUp(
        skill=Skill(name="Jinpu", damage_spec=DamageSpec(potency=320)),
        delay_after_parent_application=620,
    )
    jinpu_no_combo_follow_up = FollowUp(
        skill=Skill(name="Jinpu", damage_spec=DamageSpec(potency=160)),
        delay_after_parent_application=620,
    )
    skill_library.add_skill(
        Skill(
    ...
    shifu_follow_up = FollowUp(
        skill=Skill(name="Shifu", damage_spec=DamageSpec(potency=320)),
        delay_after_parent_application=800,
    )
    shifu_no_combo_follow_up = FollowUp(
        skill=Skill(name="Shifu", damage_spec=DamageSpec(potency=160)),
        delay_after_parent_application=800,
    )
    skill_library.add_skill(
        Skill(
    ...
    gekko_follow_up = FollowUp(
        skill=Skill(name="Gekko", damage_spec=DamageSpec(potency=440)),
        delay_after_parent_application=760,
    )
    gekko_no_combo_follow_up = FollowUp(
        skill=Skill(name="Gekko", damage_spec=DamageSpec(potency=230)),
        delay_after_parent_application=760,
    )
    gekko_no_pos_follow_up = FollowUp(
        skill=Skill(name="Gekko", damage_spec=DamageSpec(potency=390)),
        delay_after_parent_application=760,
    )
    gekko_no_pos_no_combo_follow_up = FollowUp(
        skill=Skill(name="Gekko", damage_spec=DamageSpec(potency=180)),
        delay_after_parent_application=760,
    )
    skill_library.add_skill(
        Skill(
    ...
    kasha_follow_up = FollowUp(
        skill=Skill(name="Kasha", damage_spec=DamageSpec(potency=440)),
        delay_after_parent_application=620,
    )
    kasha_no_combo_follow_up = FollowUp(
        skill=Skill(name="Kasha", damage_spec=DamageSpec(potency=230)),
        delay_after_parent_application=620,
    )
    kasha_no_pos_follow_up = FollowUp(
        skill=Skill(name="Kasha", damage_spec=DamageSpec(potency=390)),
        delay_after_parent_application=620,
    )
    kasha_no_pos_no_combo_follow_up = FollowUp(
        skill=Skill(name="Kasha", damage_spec=DamageSpec(potency=180)),
        delay_after_parent_application=620,
    )
    skill_library.add_skill(
        Skill(
