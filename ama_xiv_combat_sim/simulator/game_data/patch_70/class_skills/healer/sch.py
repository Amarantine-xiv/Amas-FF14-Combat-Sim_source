...
from ama_xiv_combat_sim.simulator.game_data.patch_70.convenience_timings import get_auto_timing, get_instant_timing_spec, get_cast_gcd_timing_spec
...
def add_sch_skills(skill_library):
    ...
    skill_library.add_skill(Skill(name='Chain Stratagem',
                                  ...
                                  debuff_spec=StatusEffectSpec(duration=2000, crit_rate_add=0.10, is_party_effect=True)))
    biolysis_dot = Skill(name='Biolysis (dot)',
                              is_GCD=False,
    ...
    skill_library.add_skill(Skill(name='Biolysis',
                                  ...
                                  timing_spec=TimingSpec(
                                      base_cast_time=0, animation_lock=650, application_delay=670),
                                  follow_up_skills=(FollowUp(skill=biolysis_dot,
                                                              delay_after_parent_application=0, dot_duration=30*1000,
                                                              snapshot_buffs_with_parent=True,
                                                              snapshot_debuffs_with_parent=True),)))
    baneful_dot = Skill(name='Baneful Impaction (dot)',
                              is_GCD=False,
                              damage_spec=DamageSpec(potency=140,
                                                    damage_class=DamageClass.MAGICAL_DOT))
    skill_library.add_skill(Skill(name='Baneful Impaction',
                                  is_GCD=True,
                                  timing_spec=TimingSpec(
                                      base_cast_time=0, animation_lock=650, application_delay=670),
                                  follow_up_skills=(FollowUp(skill=baneful_dot,
                                                              delay_after_parent_application=0, dot_duration=15*1000,
                                                              snapshot_buffs_with_parent=True,
                                                              snapshot_debuffs_with_parent=True),)))
    ...
    skill_library.add_skill(Skill(name='Aetherflow',
                                  is_GCD=False,
                                  timing_spec=instant_timing_spec))
    skill_library.add_skill(Skill(name='Concitation',
                                  is_GCD=True,
                                  timing_spec=TimingSpec(
                                      base_cast_time=2000, animation_lock=650, application_delay=670)))
    skill_library.add_skill(Skill(name='Manifestation',
                                  is_GCD=True,
                                  timing_spec=TimingSpec(
                                      base_cast_time=0, animation_lock=650, application_delay=670)))
    skill_library.add_skill(Skill(name='Accession',
                                  is_GCD=True,
                                  timing_spec=TimingSpec(
                                      base_cast_time=0, animation_lock=650, application_delay=670)))    
